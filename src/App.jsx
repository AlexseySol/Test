    ...
    >
      <div className={app.wrapper}>
        ...
        <span className={app.text}>
          Доброго дня. Нажаль я не встиг зробини іншу частину, трохи запутався
          що куди треба під'їднати. Я буду дуже вам вдячний якщо ви мені
          покажите де я зробив помилки і як правильно треба було зробити Дякую
          за увагу. Гарного дня !
        </span>
      </div>
    </ContextApp.Provider>
  );
